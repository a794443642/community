...
!function (e, t) {
    ...
    k.parseXML = function (e) {
        ...
        return t && !t.getElementsByTagName("parsererror").length || k.errorPage("Invalid XML: " + e), t
    };
    ...
    Ft.href = Et.href, k.extend({
        ...
        ajax: function (e, t) {
            ...
            if (u = "abort", b.add(v.complete), T.done(v.success), T.fail(v.errorPage), c = _t(Wt, v, t, T)) {
            ...
            function l(e, t, n, r) {
                ...
                }(v, s, T, i), i ? (v.ifModified && ((u = T.getResponseHeader("Last-Modified")) && (k.lastModified[f] = u), (u = T.getResponseHeader("etag")) && (k.etag[f] = u)), 204 === e || "HEAD" === v.type ? l = "nocontent" : 304 === e ? l = "notmodified" : (l = s.state, o = s.data, i = !(a = s.error))) : (a = l, !e && l || (l = "errorPage.html", e < 0 && (e = 0))), T.status = e, T.statusText = (t || l) + "", i ? x.resolveWith(y, [o, l, T]) : x.rejectWith(y, [T, l, a]), T.statusCode(w), w = void 0, g && m.trigger(i ? "ajaxSuccess" : "ajaxError", [T, v, i ? o : a]), b.fireWith(y, [T, l]), g && (m.trigger("ajaxComplete", [T, v]), --k.active || k.event.trigger("ajaxStop")))
            }
    ...
    y.cors = !!Xt && "withCredentials" in Xt, y.ajax = Xt = !!Xt, k.ajaxTransport(function (i) {
        ...
        if (y.cors || Xt && !i.crossDomain) return {
            send: function (e, t) {
                ...
                }, r.onload = o(), a = r.onerror = r.ontimeout = o("errorPage.html"), void 0 !== r.onabort ? r.onabort = a : r.onreadystatechange = function () {
        ...
        if (n.crossDomain || n.scriptAttrs) return {
            send: function (e, t) {
                r = k("<script>").attr(n.scriptAttrs || {}).prop({
                    ...
                    r.remove(), i = null, e && t("errorPage.html" === e.type ? 404 : 200, e.type)
    ...
    k.ajaxSetup({
        ...
        if (a || "jsonp" === e.dataTypes[0]) return r = e.jsonpCallback = m(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Yt, "$1" + r) : !1 !== e.jsonp && (e.url += (St.test(e.url) ? "&" : "?") + e.jsonp + "=" + r), e.converters["script json"] = function () {
            return o || k.errorPage(r + " was not called"), o[0]
